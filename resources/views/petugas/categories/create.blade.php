...
<div class="form-container">
    <form method="POST" action="{{ route('petugas.categories.store') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Contoh: Fiksi, Non-Fiksi, Teknologi">
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" rows="4" placeholder="Jelaskan kategori ini (opsional)">{{ old('description') }}</textarea>
