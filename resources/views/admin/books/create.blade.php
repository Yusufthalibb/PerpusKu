        ...
        <div class="mb-8 animate-fadeInUp">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Lengkapi formulir di bawah untuk menambahkan buku ke perpustakaan</p>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="shelf_code" id="shelf_code" value="{{ old('shelf_code') }}" 
                    ...
                    <div class="animate-fadeInUp" style="animation-delay: 0.4s">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" rows="5" 
                                ...
                                placeholder="Tuliskan sinopsis atau deskripsi buku...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            ...
                            <div class="flex items-start gap-4">
                                    ...
                                    <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#D32F2F] transition-all duration-200 cursor-pointer" id="dropZone">
                                        ...
                                        <div id="uploadPrompt">
                                            ...
                                            <p class="mt-2 text-sm text-gray-600">
                                                <label for="cover" class="text-[#D32F2F] hover:text-[#B71C1C] font-medium cursor-pointer">Upload file</label>
                                                atau drag & drop
                                            </p>
                                ...
                                <div id="previewContainer" class="hidden">
                                    <div class="relative group">
                                        <img id="coverPreview" src="" alt="Preview" class="w-32 h-44 object-cover rounded-lg border-2 border-gray-200 shadow-sm">
...
<div id="confirmModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
        <div class="p-6">
            ...
            <p class="text-sm text-gray-600 mb-6">Data yang sudah diisi akan hilang dan tidak dapat dikembalikan.</p>
        ...
        if (!btn.closest('#confirmModal')) {
            btn.addEventListener('click', function(e) {
                ...
                inputs.forEach(input => {
                    if (input.type !== 'file' && input.value && input.value !== input.defaultValue) {
                        isModified = true;
                    }
